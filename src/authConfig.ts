...
const clientId = '2b5094dc-9c8d-4e5d-9a5a-eaf5836860e1';
const tenantName = '0e21424b-edde-44a1-a63b-04055bc7a849';

const flows = {
    localAccSignIn: 'B2C_1_email', //e.g., B2C_1_main_flow
    msid: 'B2C_1_msid',
}
